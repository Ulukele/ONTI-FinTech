...
{"id": "da04e377-47f1-c749-54ca-0fc5a08f0595"}
$ faceid.py --add 6104 +79991234567
Failed but included in 0xb6477a31e41e27dc2f2cbe4c2bbb37b5a6a34683d5cbca4a1a706df5525a2d30
```

Первый запрос на регистрацию соответствия успешно подтвержден, но транзакция регистрации соответствия с таким же номером телефона включается с блок со статусом исполнения - ошибка, поскольку такой номер телефона уже зарегистрирован в системе. Статус можно подтвердить для данной транзакции в браузере блоков.
